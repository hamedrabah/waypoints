      ...
      if (!helloWorldSection) {
        ...
        helloWorldSection.innerHTML = `
          ...
          <div class="card-body markdown-content">
            ...
            <p>This is a working prototype of a map-first interface that enables fast drone waypoint insertion, real-time incident monitoring, and image-based location identification—purpose-built for Drone as First Responder (DFR) workflows. The project simulates how an RTCC or dispatch operator could rapidly deploy Skydio drones in an urban environment with minimal input friction and maximum operational clarity.</p>

            <p>The demo is scoped to San Francisco by design—balancing real-world data integration with the constraints of a focused, high-fidelity test environment.</p>
            ...
            <blockquote>
              <p><strong>Use case:</strong> A dispatcher receives a photo from a civilian tipline or internal BWC footage—before the officer finishes describing the location, the system suggests GPS coordinates.</p>
            </blockquote>

            <hr>

            <h3>📡 Real-Time Calls for Service Integration (Socrata API)</h3>
            ...
            <h3>🗺️ Map-Centered Interface with Flexible Inputs</h3>
            ...
            <ul>
              <li><strong>San Francisco Geofence:</strong> This isn't a limitation—it's a realism choice. It allows high-quality testing and reflects how actual DFR deployments start within tightly defined municipal boundaries.</li>
            ...
            <p>This tool isn't just a demo—it reflects real pain points from actual public safety workflows. It was designed with the field realities of RTCCs, drone operators, and dispatchers in mind.</p>
